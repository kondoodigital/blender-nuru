...
def draw_material_surface_settings(layout, mat, scene=None, is_eevee=True):
    use_nuru = scene is not None and scene.eevee.ray_tracing_method == 'HARDWARE'
...
def draw_material_settings(self, context):
    ...
    draw_material_surface_settings(layout, mat, context.scene, False)
...
class EEVEE_MATERIAL_PT_settings_surface(MaterialButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        draw_material_surface_settings(layout, mat, context.scene)
