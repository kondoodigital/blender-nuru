...
class RENDER_PT_eevee_raytracing(RenderButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        if props.ray_tracing_method == 'HARDWARE':
            ...
            section.label(text="Global Illumination")
            ...
            row = section.row(align=True)
            row.active = props.use_hardware_raytracing_gi or props.use_hardware_raytracing_environment
            ...
            section = quick_col.column(align=True)
            section.label(text="Raytrace Environment")
            row = section.row(align=True)
            row.prop(props, "use_hardware_raytracing_environment", text="On")
