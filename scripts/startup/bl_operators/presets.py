...
class AddPresetEEVEERaytracing(AddPresetBase, Operator):
    ...
    preset_values = [
        ...
        "options.gi_spatial_samples",
        "eevee.hardware_raytracing_shadow_samples",
        "options.trace_max_roughness",
        "options.screen_trace_quality",
        "options.screen_trace_thickness",
        "options.use_denoise",
        "options.denoise_filter",
        "options.denoise_input_passes",
        "options.denoise_prefilter",
        "options.denoise_quality",
        "options.denoise_sample_interval",
        "options.denoise_use_gpu",
