...
/// @hideinitializer
#define OPENVDB_LIBRARY_VERSION_STRING "13.0.0"
...
/// (although the two are usually the same).
/// @hideinitializer
#define OPENVDB_LIBRARY_ABI_VERSION_STRING "13.0.0abi13"

/// @brief Library version number as a packed integer ("%02x%02x%04x", major, minor, patch)
/// @hideinitializer
#define OPENVDB_LIBRARY_VERSION_NUMBER 218103808
...
/// where X, Y and N are the major, minor and ABI version numbers, respectively.
    ...
    #define OPENVDB_VERSION_NAME v13_0
#else
    #define OPENVDB_VERSION_NAME v13_0abi13
#endif
