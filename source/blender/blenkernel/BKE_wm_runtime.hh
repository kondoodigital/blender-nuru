...
struct WindowRuntime {
  ...
  /**
   * Number of active non-viewport UI interactions that should keep menus and property editing
   * responsive by throttling repeated viewport redraws.
   */
  int non_view3d_ui_interaction_count = 0;

  /**
   * Next time a throttled `VIEW_3D` redraw is allowed while non-viewport UI interaction is active.
   */
  double next_nuru_view3d_redraw_time = 0.0;
