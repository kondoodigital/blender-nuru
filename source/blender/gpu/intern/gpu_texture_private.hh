 ...
 * Nuru: raised from 8. The hardware ray tracing lighting pass binds 9 images (slots 0-8);
 * with the vanilla limit, slot 8 wrote one byte past #StateManager::image_formats and
 * #ShaderInterface::image_formats_, corrupting adjacent members. */
#define GPU_MAX_IMAGE 16
