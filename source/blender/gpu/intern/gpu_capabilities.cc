...
bool GPU_viewport_hardware_raytracing_support()
{
   ...
   * capability bit alone. The current backend is Metal-only; future RTX/OptiX-capable backends
   * can extend this gate once Eevee owns a real viewport path there too. */
