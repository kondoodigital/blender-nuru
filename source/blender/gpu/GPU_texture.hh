 ...
 *
 * Blender 5.1 keeps this public hook for user preference updates. The imported GPU
 * texture code stores sampler state on textures, so the compatibility implementation is a no-op.
 */
