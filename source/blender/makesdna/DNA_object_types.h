...
/** #Object.visibility_extra_flag */
enum {
  /** Hide this object from Nuru Snell caustic bending/receiver photon paths. */
  OB_HIDE_CAUSTICS = 1 << 0,
};
...
struct Object {
  ...
  /** Extra visibility flags for render features that do not fit in #visibility_flag. */
  char visibility_extra_flag = 0;
