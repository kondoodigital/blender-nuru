...
struct SceneEEVEE {
  ...
  int ray_tracing_reflection_bounces = 2;
  int ray_tracing_refraction_bounces = 2;
  ...
  int hardware_raytracing_refraction_mode = RAYTRACE_EEVEE_SPECULAR_MODE_OFF;
  int ray_tracing_caustics_samples = 8;
  char hardware_raytracing_indirect_flags = 0;
  char _pad_ray_tracing[3] = {};
  /* Deprecated blend-file padding after removing the environment softness control. */
  float ray_tracing_environment_shadow_softness = 1.0f;
