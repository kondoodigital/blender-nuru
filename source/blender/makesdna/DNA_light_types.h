...
enum {
  ...
  /** Nuru: the light's image is rendered in sharp (mirror-like) reflections. Off by default:
   * large area/sphere lights otherwise splat their shape into every mirror. */
  LA_VISIBLE_REFLECTIONS = 1 << 24,
