                                       ...
                                       ResourceIndex res_index)
{
  ...
  create_command(Type::DrawIndirect).draw_indirect = {
      batch, &indirect_buffer, 0, GPU_PRIM_NONE, 0, res_index};
}
                                              ...
                                              ResourceIndex res_index)
{
  BLI_assert(shader_);
  create_command(Type::DrawIndirect).draw_indirect = {
      batch, indirect_buffer, indirect_offset, primitive_type, primitive_len, res_index};
}
                                              ...
                                              ResourceIndex res_index)
{
  this->draw_expand_indirect(
      batch, primitive_type, primitive_len, &indirect_buffer, indirect_offset, res_index);
}
