...
#if defined(EEVEE_HIT_EVAL_GENERATED_ORCO) && !defined(GPU_METAL)
...
#  ifdef GPU_VERTEX_SHADER
  ...
  if (orco.w == 1.0f) {
#    ifdef EEVEE_HIT_EVAL_GENERATED_ORCO
    return eevee_hit_eval_generated_orco();
#    else
...
#  elif defined(EEVEE_HIT_EVAL_GENERATED_ORCO)
  if (orco.w == 1.0f) {
    return eevee_hit_eval_generated_orco();
  }
#  endif
