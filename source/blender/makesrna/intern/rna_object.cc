...
static void rna_def_object_visibility(StructRNA *srna)
{
  ...
  prop = RNA_def_property(srna, "visible_caustics", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_negative_sdna(
      prop, nullptr, "visibility_extra_flag", OB_HIDE_CAUSTICS);
  RNA_def_property_ui_text(
      prop, "Caustics Visibility", "Object visibility to Nuru Snell caustic rays");
  RNA_def_property_update(prop, NC_OBJECT | ND_DRAW, "rna_Object_internal_update_draw");
