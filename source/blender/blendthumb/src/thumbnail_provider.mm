 ...
 *   xattr -rl bin/Blender-Nuru.app/Contents/Plugins/blender-thumbnailer.appex
 ...
 * bin/Blender-Nuru.app/Contents/PlugIns/blender-thumbnailer.appex/Contents/MacOS/blender-thumbnailer
 * - Is it codesigned and sandboxed?
 *   codesign --display --verbose --entitlements - --xml \
 * bin/Blender-Nuru.app/Contents/Plugins/blender-thumbnailer.appex codesign --deep --force --sign - \
 * --entitlements ../blender/release/darwin/thumbnailer_entitlements.plist --timestamp=none \
 * bin/Blender-Nuru.app/Contents/Plugins/blender-thumbnailer.appex
